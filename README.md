...
> Unified platform extension: this repository now also contains an application domain for transcript extraction and knowledge-base generation at `apps/knowledge-pipeline/`.
...
│
├── apps/
│   └── knowledge-pipeline/           # Udemy transcript + KB generation automation
...
│
├── docs/
│   └── SOLUTION_ARCHITECTURE.md      # Unified transcript + KB + IaC operating model
│
