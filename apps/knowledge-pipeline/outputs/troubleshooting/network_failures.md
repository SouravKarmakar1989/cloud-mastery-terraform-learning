...
- Domain sequence including network-related issues is explicit in section-maps/BATCH-014_section_concept_map.md (Troubleshooting section intro).
- Network troubleshooting concepts map to merged/01_global_concept_map.md entries for Pod Networking, Service Networking, DNS in Kubernetes, Ingress, and CNI in Kubernetes.
