...
- section-maps/BATCH-014_section_concept_map.md (Troubleshooting section, including Application, Control Plane, Worker Node failures)
- merged/01_global_concept_map.md (Global concepts: Control Plane Failure, Worker Node Failure, Pod Networking, Service Networking, DNS in Kubernetes, Persistent Volumes, Persistent Volume Claims, Storage Class, Security Contexts, Service Accounts)
...
## Source Anchors
- Troubleshooting structure and workflow sequencing: section-maps/BATCH-014_section_concept_map.md
