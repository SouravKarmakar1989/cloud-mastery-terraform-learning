# Extraction: certified-kubernetes-administrator-with-practice-tests / 13_(2025 Updates)Kustomize Basics / 266_The kustomization.yaml File
...
- Lecture: 266_The kustomization.yaml File
- File: 266_The kustomization.yaml File.txt
- Topic: The kustomization.yaml File
...
Content:
We learned that Kustomize will look for a customization file, which is going to contain the two following things, a list of all of the Kubernetes resources or manifests that Kustomize should manage, as well as all of the customizations that should be applied.
