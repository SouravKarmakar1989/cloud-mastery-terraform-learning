...
- outputs/aws-solutions-architect-professional/08_Databases/088_DynamoDB.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/21_Databases in AWS/237_DynamoDB.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/315_DynamoDB WCU & RCU - Throughput.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/324_DynamoDB DAX.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/321_DynamoDB Indexes (GSI + LSI) - Hands On.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/325_DynamoDB DAX - Hands On.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/320_DynamoDB Indexes (GSI + LSI).txt
- outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt
- outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/044_Hands-On_ Configure DynamoDB Indexes.txt
...
- outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt
- outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/044_Hands-On_ Configure DynamoDB Indexes.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/326_DynamoDB Streams.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/316_DynamoDB WCU & RCU - Hands On.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/315_DynamoDB WCU & RCU - Throughput.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/21_Databases in AWS/237_DynamoDB.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/312_DynamoDB - Section Introduction.txt
- Top concept clusters from transcript metadata:
- NoSQL Access Patterns
...
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/312_DynamoDB - Section Introduction.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/320_DynamoDB Indexes (GSI + LSI).txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/336_DynamoDB Security & Other.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/314_DynamoDB Basics - Hands On.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/21_Databases in AWS/237_DynamoDB.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/315_DynamoDB WCU & RCU - Throughput.txt
- outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/327_DynamoDB Streams - Hands On.txt
- outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/040_Understanding DynamoDB Capacity - Properly Size DynamoDB and Reduce Costs.txt
- Top concept clusters from transcript metadata:
- NoSQL Access Patterns
...
- outputs/aws-certified-solutions-architect-associate-saa-c03/19_Serverless Overviews from a Solution Architect Perspective/222_Amazon DynamoDB.txt (owned by AWS Compute Knowledge Base)
- outputs/aws-certified-solutions-architect-associate-saa-c03/19_Serverless Overviews from a Solution Architect Perspective/223_Amazon DynamoDB - Hands-On.txt (owned by AWS Compute Knowledge Base)
- outputs/aws-certified-solutions-architect-associate-saa-c03/19_Serverless Overviews from a Solution Architect Perspective/224_Amazon DynamoDB - Advanced Features.txt (owned by AWS Compute Knowledge Base)
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/036_Database Scaling_ Vertical vs. Horizontal.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/039_Hands-On_ Create a DynamoDB Table with Partition and Sort Keys.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/040_Understanding DynamoDB Capacity - Properly Size DynamoDB and Reduce Costs.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/041_Hands-On_ Configure DynamoDB Capacity - Provisioned and On-Demand.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/042_DynamoDB API Basics for Cert Prep.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/044_Hands-On_ Configure DynamoDB Indexes.txt
...
### File: outputs/AWS Storage and DB/awsdatabase/04_DynamoDB/045_Bonus Lecture.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/312_DynamoDB - Section Introduction.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/313_DynamoDB Overview.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/314_DynamoDB Basics - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/315_DynamoDB WCU & RCU - Throughput.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/316_DynamoDB WCU & RCU - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/317_DynamoDB - Basic Operations.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/318_DynamoDB Basic APIs - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/319_DynamoDB - Conditional Writes.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/320_DynamoDB Indexes (GSI + LSI).txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/321_DynamoDB Indexes (GSI + LSI) - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/322_DynamoDB PartiQL.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/323_DynamoDB Optimistic Locking.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/324_DynamoDB DAX.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/325_DynamoDB DAX - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/326_DynamoDB Streams.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/327_DynamoDB Streams - Hands On.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/328_DynamoDB TTL.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/329_DynamoDB CLI.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/330_DynamoDB Transactions.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/331_DynamoDB Session State.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/332_DynamoDB Partitioning Strategies.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/333_DynamoDB Conditional Writes, Concurrent Writes & Atomic Writes.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/335_DynamoDB Operations.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/22_AWS Serverless_ DynamoDB/336_DynamoDB Security & Other.txt
...
### File: outputs/aws-certified-developer-associate-dva-c01/25_AWS Serverless_ SAM - Serverless Application Model/379_SAM with DynamoDB - Hands On.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/21_Databases in AWS/237_DynamoDB.txt
...
### File: outputs/aws-solutions-architect-professional/08_Databases/088_DynamoDB.txt
...
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:6: We don't want to have to look through the entire table when we want to perform a query.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:41: The lsis must be created when the table is created.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:47: So for example, let's say that we have a book with the partition key of B001.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:55: And in a global secondary index is going to allow you to define a new primary key, not a sort key, but a primary key, meaning that you can query your data in in a totally different way than your base table allows.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:71: Like for example, we don't have enough write capacity units for the global secondary index because every time data is written, DynamoDB must update its table, but it also has to update the global secondary index as well.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:74: So when you write to a DynamoDB table that has a global secondary index, DynamoDB actually has to do two separate writes behind the scenes.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:82: And so when you're thinking about these secondary indexes, you really want to start from a perspective of what are the questions that my application is going to need to ask?
...
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:41: The lsis must be created when the table is created.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:42: You cannot add them later.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:46: There is a ten gigabyte item collection limit, so each partition key in all of the related items can't exceed ten gigabytes total.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:48: Well, all of the items with that particular partition key cannot exceed ten gigabytes.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:50: And you can't delete Lcis once they're created.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:71: Like for example, we don't have enough write capacity units for the global secondary index because every time data is written, DynamoDB must update its table, but it also has to update the global secondary index as well.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:72: And if it can't do that, then DynamoDB won't be able to perform its write.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:78: And those writes must succeed together.
- 043_DynamoDB Indexes — Search Effectively with LSI and GSI.txt:84: And then design your indexes around those queries and only those queries that are going to happen frequently in real life.
