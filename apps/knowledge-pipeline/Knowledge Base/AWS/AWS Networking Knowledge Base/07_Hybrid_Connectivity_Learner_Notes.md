...
### Lab 1: Hybrid Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `07_Hybrid_Connectivity.md` and summarize the primary decision points.
