...
### Lab 1: Route 53 Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `05_Route53_DNS_Routing.md` and summarize the primary decision points.
...
### Lab 3: Policy-Driven Traffic Decisions
Goal: translate theory into an observable and repeatable workflow.
