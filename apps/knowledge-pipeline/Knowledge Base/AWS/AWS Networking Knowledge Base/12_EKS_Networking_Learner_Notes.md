...
### Lab 1: EKS Networking Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `12_EKS_Networking.md` and summarize the primary decision points.
...
### Lab 2: Cluster and Pod Behavior
Goal: translate theory into an observable and repeatable workflow.
...
### Lab 3: Address and Scale Planning
Goal: translate theory into an observable and repeatable workflow.
