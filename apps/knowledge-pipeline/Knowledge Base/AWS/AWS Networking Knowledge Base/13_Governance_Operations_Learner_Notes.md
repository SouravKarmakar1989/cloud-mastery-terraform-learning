...
### Lab 1: Governance Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `13_Governance_Operations.md` and summarize the primary decision points.
...
### Lab 2: Core Governance Dimensions
Goal: translate theory into an observable and repeatable workflow.
