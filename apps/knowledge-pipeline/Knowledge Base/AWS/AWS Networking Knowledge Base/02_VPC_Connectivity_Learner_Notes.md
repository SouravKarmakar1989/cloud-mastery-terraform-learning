...
### Lab 1: Connectivity Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `02_VPC_Connectivity.md` and summarize the primary decision points.
...
### Lab 2: Private Connectivity Options
Goal: translate theory into an observable and repeatable workflow.
