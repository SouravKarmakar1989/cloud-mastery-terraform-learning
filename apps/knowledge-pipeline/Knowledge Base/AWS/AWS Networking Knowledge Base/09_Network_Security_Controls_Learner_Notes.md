...
### Lab 1: Network Security Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `09_Network_Security_Controls.md` and summarize the primary decision points.
