...
### Lab 1: VPC Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `01_VPC_Core.md` and summarize the primary decision points.
...
### Lab 2: Core Addressing and Segmentation
Goal: translate theory into an observable and repeatable workflow.
...
### Lab 3: Baseline Traffic Controls
Goal: translate theory into an observable and repeatable workflow.
