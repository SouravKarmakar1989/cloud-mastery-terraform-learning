...
### Lab 1: Troubleshooting Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `08_Traffic_Analysis_Troubleshooting.md` and summarize the primary decision points.
...
### Lab 3: Investigation Discipline
Goal: translate theory into an observable and repeatable workflow.
