...
### Lab 1: DNS Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `03_VPC_DNS_DHCP.md` and summarize the primary decision points.
...
### Lab 2: Namespace and Resolution Design
Goal: translate theory into an observable and repeatable workflow.
...
### Lab 3: Host Configuration Baseline
Goal: translate theory into an observable and repeatable workflow.
