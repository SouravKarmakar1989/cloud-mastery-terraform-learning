...
### Lab 1: Transit Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `11_Transit_CloudWAN_Lattice.md` and summarize the primary decision points.
...
### Lab 3: Service-Network Abstraction
Goal: translate theory into an observable and repeatable workflow.
