...
### Lab 1: Load Balancing Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `04_Load_Balancing.md` and summarize the primary decision points.
...
### Lab 3: Trust and Session Behavior
Goal: translate theory into an observable and repeatable workflow.
