...
### Lab 1: Performance Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `10_Network_Performance_Optimization.md` and summarize the primary decision points.
...
### Lab 2: Instance and Topology Effects
Goal: translate theory into an observable and repeatable workflow.
...
### Lab 3: Architectural Trade-offs
Goal: translate theory into an observable and repeatable workflow.
