...
### Lab 1: Edge Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `06_Global_Edge_Acceleration.md` and summarize the primary decision points.
...
### Lab 2: Caching vs Transport Optimization
Goal: translate theory into an observable and repeatable workflow.
...
### Lab 3: Global Entry Constraints
Goal: translate theory into an observable and repeatable workflow.
