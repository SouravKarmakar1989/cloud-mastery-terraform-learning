...
#### 1. Containers Orchestration Mental Model
...
### Lab 1: Containers Orchestration Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `03_Containers_Orchestration.md` and summarize the primary decision points.
