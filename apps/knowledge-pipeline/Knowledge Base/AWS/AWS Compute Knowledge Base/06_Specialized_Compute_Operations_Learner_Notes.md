...
#### 1. Specialized Compute Operations Mental Model
...
### Lab 1: Specialized Compute Operations Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `06_Specialized_Compute_Operations.md` and summarize the primary decision points.
