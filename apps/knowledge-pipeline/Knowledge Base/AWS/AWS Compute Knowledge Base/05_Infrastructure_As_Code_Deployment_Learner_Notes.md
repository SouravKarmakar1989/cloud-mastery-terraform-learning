...
#### 1. Infrastructure As Code Deployment Mental Model
...
### Lab 1: Infrastructure As Code Deployment Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `05_Infrastructure_As_Code_Deployment.md` and summarize the primary decision points.
