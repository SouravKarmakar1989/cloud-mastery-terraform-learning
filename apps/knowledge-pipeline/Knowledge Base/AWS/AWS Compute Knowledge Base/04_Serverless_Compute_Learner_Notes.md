...
#### 1. Serverless Compute Mental Model
...
### Lab 1: Serverless Compute Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `04_Serverless_Compute.md` and summarize the primary decision points.
