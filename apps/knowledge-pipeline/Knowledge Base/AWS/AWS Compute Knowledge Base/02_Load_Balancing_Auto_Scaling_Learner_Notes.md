...
#### 1. Load Balancing Auto Scaling Mental Model
...
### Lab 1: Load Balancing Auto Scaling Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `02_Load_Balancing_Auto_Scaling.md` and summarize the primary decision points.
