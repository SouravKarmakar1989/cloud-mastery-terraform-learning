...
### Lab 1: Relational Databases Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `01_Relational_Databases.md` and summarize the primary decision points.
