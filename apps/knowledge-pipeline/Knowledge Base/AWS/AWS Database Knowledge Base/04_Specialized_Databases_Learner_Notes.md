...
### Lab 1: Specialized Databases Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `04_Specialized_Databases.md` and summarize the primary decision points.
