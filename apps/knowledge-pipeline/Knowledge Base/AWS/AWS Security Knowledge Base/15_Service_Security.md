...
- outputs/AWS/AWS Speciality/Security/09_Other Services/255_Lambda Security.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/256_[DVA] Lambda in VPC.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/264_[CCP] Amazon WorkSpaces.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/270_[SOA] EC2 Image Builder Hands On.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/262_[SAA] Glue Overview.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/257_[DVA] Lambda in VPC - Hands On.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/258_[DVA] Lambda Function URL.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/252_ECR Security.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/260_AWS Signer.txt
...
- outputs/AWS/AWS Speciality/Security/09_Other Services/252_ECR Security.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/260_AWS Signer.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/263_Glue Security.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/270_[SOA] EC2 Image Builder Hands On.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/272_Redshift Security.txt
- outputs/AWS/AWS Speciality/Security/09_Other Services/258_[DVA] Lambda Function URL.txt
- Top concept clusters from transcript metadata:
- Governance/Platform Operational Context
- Workload Platform Security
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/252_ECR Security.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/253_ECS Secret Management.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/254_EKS Concepts.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/255_Lambda Security.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/256_[DVA] Lambda in VPC.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/257_[DVA] Lambda in VPC - Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/258_[DVA] Lambda Function URL.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/259_[DVA] Lambda Function URL - Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/260_AWS Signer.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/261_AWS Verified Access.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/262_[SAA] Glue Overview.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/263_Glue Security.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/264_[CCP] Amazon WorkSpaces.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/265_Amazon Workspaces - Security.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/266_ASG Instance Refresh.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/267_EBS - Data Volume Wiping.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/268_CloudShell.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/269_[CCP_SOA] EC2 Image Builder.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/270_[SOA] EC2 Image Builder Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/271_EC2 Image Builder - Troubleshooting.txt
...
### File: outputs/AWS/AWS Speciality/Security/09_Other Services/272_Redshift Security.txt
