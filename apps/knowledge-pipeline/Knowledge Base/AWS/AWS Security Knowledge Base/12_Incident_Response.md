...
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/068_[SAA_DVA_SOA] SSM Parameter Store Overview.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/063_[SOA] Systems Manager Overview.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/055_Compromised AWS Credentials.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/052_[CCP_SOA] Penetration Testing on AWS.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/067_[SOA] SSM Automations.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/070_[SOA] SSM Inventory & State Manager.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/069_[SAA_DVA_SOA] SSM Parameter Store Hands On (CLI).txt
...
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/067_[SOA] SSM Automations.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/070_[SOA] SSM Inventory & State Manager.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/065_[SOA] AWS Tags & SSM Resource Groups.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/072_[SOA] SSM Patch Manager and Maintenance Windows - Hands On.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/069_[SAA_DVA_SOA] SSM Parameter Store Hands On (CLI).txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/059_Lost EC2 Key Pair - Linux.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/071_[SOA] SSM Patch Manager and Maintenance Windows.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/054_Compromised AWS Resources.txt
- outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/068_[SAA_DVA_SOA] SSM Parameter Store Overview.txt
- Top concept clusters from transcript metadata:
- Incident Response Operational Context
- Operational Remediation
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/052_[CCP_SOA] Penetration Testing on AWS.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/053_DDoS Simulation Testing on AWS.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/054_Compromised AWS Resources.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/055_Compromised AWS Credentials.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/056_EC2 Key Pairs & Remediating Exposed EC2 Key Paris.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/057_EC2 Instance Connect.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/058_EC2 Serial Console.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/059_Lost EC2 Key Pair - Linux.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/060_Lost EC2 Key Pair - Windows.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/061_EC2 Rescue Tool for Linux & Windows.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/062_AWS Abuse Report.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/063_[SOA] Systems Manager Overview.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/064_[SOA] Start EC2 Instances with SSM Agent.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/065_[SOA] AWS Tags & SSM Resource Groups.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/066_[SOA] SSM Documents & SSM Run Command.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/067_[SOA] SSM Automations.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/068_[SAA_DVA_SOA] SSM Parameter Store Overview.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/069_[SAA_DVA_SOA] SSM Parameter Store Hands On (CLI).txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/070_[SOA] SSM Inventory & State Manager.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/071_[SOA] SSM Patch Manager and Maintenance Windows.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/072_[SOA] SSM Patch Manager and Maintenance Windows - Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/073_[SOA] SSM Session Manager Overview.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/074_[SOA] SSM Session Manager Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/04_Domain 2 - Incident Response/075_[SOA] SSM Cleanup.txt
...
## Step 3 â€” Deep Expansion (Core Incident Response Concepts)
