...
> Source: aws-certified-cloudops-associate transcripts â€” 252_[SAA] AWS Backup.txt, 270_KMS For CloudOps.txt

### AWS Backup â€” Centralised Backup Service
- Fully managed service to centrally manage and automate backups across AWS services â€” no custom scripts or manual processes needed.
...
- **Cross-region backups**: backup data can be pushed to a different AWS region for DR â€” managed in one central place.
...
- Backup data is stored in an **internal S3 bucket** that is fully managed by AWS Backup â€” not directly accessible by the user.
- **Backup Vault Lock (WORM)**: enforce a Write Once Read Many policy on a Backup Vault â€” all backups in the vault cannot be deleted; even the **root user cannot delete backups** when Vault Lock is enabled. Protects against accidental or malicious delete and against retention period shortening.
...
- **Cancel deletion** is available during the waiting period â€” use `disable` first if you are unsure whether the key is still needed.
- **Automation to detect key-still-in-use**:
	1. Schedule CMK deletion â†’ key enters Pending Deletion
	...
	5. Set a **CloudWatch Alarm** on that metric â†’ trigger an **SNS notification** (email/SMS)
	6. Receipt of the alert confirms the CMK is still being used â†’ cancel deletion and investigate
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/07_Securing Access to Your Data/069_Amazon S3 Presigned URLs.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/07_Securing Access to Your Data/070_Demo - Amazon S3 Presigned URLs.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/074_Protecting Your Data with Amazon S3 Encryption.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/075_Introduction to Client-Side Encryption.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/076_Using Server-Side Encryption with Amazon S3.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/082_In-Transit Encryption.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/083_Demo - In-Transit Encryption.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/08_Protecting Your Data in Amazon S3/095_Amazon S3 MFA Delete.txt
...
### File: outputs/AWS/AWS Storage and DB/amazon-s3-deep-dive/10_S3 Monitoring and Alerts/103_Amazon S3 Server Access Logs.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/141_S3 Encryption.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/143_S3 Encryption - Hands On.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/144_S3 Default Encryption.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/147_S3 MFA Delete.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/148_S3 MFA Delete Hands On.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/149_S3 Access Logs.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/14_Amazon S3 Security/150_S3 Access Logs - Hands On.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-associate-SAA-C03/16_AWS Storage Extras/174_Architecture_ Snowball into Glacier.txt
