...
### Lab 1: Storage Cost Performance Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `06_Storage_Cost_Performance.md` and summarize the primary decision points.
