...
### Lab 1: S3 Foundations Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `01_S3_Foundations.md` and summarize the primary decision points.
