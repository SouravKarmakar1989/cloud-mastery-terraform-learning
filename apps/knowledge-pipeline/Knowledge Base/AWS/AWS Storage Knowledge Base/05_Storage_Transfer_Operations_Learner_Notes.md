...
### Lab 1: Storage Transfer Operations Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `05_Storage_Transfer_Operations.md` and summarize the primary decision points.
