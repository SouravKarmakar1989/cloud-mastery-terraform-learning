...
### Lab 1: Block File Hybrid Storage Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `03_Block_File_Hybrid_Storage.md` and summarize the primary decision points.
