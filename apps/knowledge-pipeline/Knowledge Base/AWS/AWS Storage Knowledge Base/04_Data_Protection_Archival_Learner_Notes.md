...
### Lab 1: Data Protection Archival Mental Model
Goal: translate theory into an observable and repeatable workflow.

1. Read the corresponding module section in `04_Data_Protection_Archival.md` and summarize the primary decision points.
