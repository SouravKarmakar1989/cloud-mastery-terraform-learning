...
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/035_CloudTrail to CloudWatch Metrics Filter - Example.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/022_[SAA_DVA_SOA] CloudWatch Alarms.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/043_[SAA_SOA] VPC Flow Logs Hands On.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/017_[SOA] CloudWatch - Unified CloudWatch Agent - Overview.txt
- outputs/AWS/aws-certified-developer-associate-DVA-C01/20_AWS Monitoring & Audit_ CloudWatch, X-Ray and CloudTrail/242_CloudWatch Agent & CloudWatch Logs Agent.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/018_[SOA_DOP] CloudWatch - Unified CloudWatch Agent - Hands On.txt
- outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/114_CloudWatch.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/024_CloudWatch Contributor Insights.txt
- outputs/AWS/AWS Speciality/advanced-networking-specialty/14_Direct Connect (DX)/139_DX Monitoring using CloudWatch.txt
- outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/115_CloudWatch Logs.txt
...
- Primary transcript files:
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/018_[SOA_DOP] CloudWatch - Unified CloudWatch Agent - Hands On.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/019_CloudWatch Unified Agent - Troubleshooting.txt
- outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/115_CloudWatch Logs.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/017_[SOA] CloudWatch - Unified CloudWatch Agent - Overview.txt
- outputs/AWS/aws-certified-developer-associate-DVA-C01/20_AWS Monitoring & Audit_ CloudWatch, X-Ray and CloudTrail/242_CloudWatch Agent & CloudWatch Logs Agent.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/020_[SAA_DVA_SOA] CloudWatch Logs.txt
- outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/114_CloudWatch.txt
- outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/035_CloudTrail to CloudWatch Metrics Filter - Example.txt
- Top concept clusters from transcript metadata:
- Audit Logging
...
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/259_Amazon CloudWatch - Metrics.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/260_Amazon CloudWatch - Logs.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/261_Amazon CloudWatch - Logs - Hands On.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/262_Amazon CloudWatch - Logs Unified Agent.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/263_Amazon CloudWatch - Alarms.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/2. aws-machine-learning-engineer-associate/11_Management and Governance/264_Amazon CloudWatch - Alarms - Hands On.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/3. aws-generative-ai-developer-professional/08_Governance and QA/184_CloudWatch Logs.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/3. aws-generative-ai-developer-professional/08_Governance and QA/185_CloudWatch Logs - Hands On.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/3. aws-generative-ai-developer-professional/08_Governance and QA/186_CloudWatch Alarms.txt (owned by AWS AI Knowledge Base)
- outputs/AWS/AWS AI/3. aws-generative-ai-developer-professional/08_Governance and QA/187_CloudWatch Alarms - Hands On.txt (owned by AWS AI Knowledge Base)
...
- outputs/AWS/aws-certified-developer-associate-DVA-C01/21_AWS Serverless_ Lambda/274_Lambda & CloudWatch Events _ EventBridge.txt (owned by AWS Compute Knowledge Base)
- outputs/AWS/aws-certified-developer-associate-DVA-C01/21_AWS Serverless_ Lambda/275_Lambda & CloudWatch Events _ EventBridge Hands On.txt (owned by AWS Compute Knowledge Base)

## CloudOps Transcript Additions â€” Monitoring, Metrics, Logs, and Health

### Source Files
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/198_CloudWatch Metrics.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/199_CloudWatch Custom Metrics.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/200_CloudWatch Anomaly Detection.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/201_CloudWatch Dashboards.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/202_CloudWatch Logs.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/203_CloudWatch Logs - Hands On.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/204_CloudWatch Logs - Live Tail - Hands On.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/205_CloudWatch Logs - Data Protection.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/206_CloudWatch Alarms.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/207_CloudWatch Alarms Hands On.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/208_CloudWatch Synthetics.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/209_CloudWatch Synthetics - in a VPC.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/210_CloudWatch Container Insights.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/211_CloudWatch Internet Monitor.txt
- outputs/AWS/aws-certified-cloudops-engineer-associate-SOA-C03/16_Monitoring, Auditing and Performance/212_CloudWatch Network Synthetic Monitor.txt
...
### File: outputs/AWS/AWS Speciality/advanced-networking-specialty/14_Direct Connect (DX)/139_DX Monitoring using CloudWatch.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/017_[SOA] CloudWatch - Unified CloudWatch Agent - Overview.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/018_[SOA_DOP] CloudWatch - Unified CloudWatch Agent - Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/019_CloudWatch Unified Agent - Troubleshooting.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/020_[SAA_DVA_SOA] CloudWatch Logs.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/021_[SAA_DVA_SOA] CloudWatch Logs Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/022_[SAA_DVA_SOA] CloudWatch Alarms.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/023_[SAA_DVA_SOA] CloudWatch Alarms Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/024_CloudWatch Contributor Insights.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/035_CloudTrail to CloudWatch Metrics Filter - Example.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/042_[SAA_SOA] VPC Flow Logs.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/043_[SAA_SOA] VPC Flow Logs Hands On.txt
...
### File: outputs/AWS/AWS Speciality/Security/03_Domain 1 - Detection/044_VPC Flow Logs - Advanced.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/10_VPC Fundamentals/110_NACL, SG, VPC Flow Logs.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/15_CloudFront/166_CloudFront - Real Time Logs.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/20_AWS Monitoring & Audit_ CloudWatch, X-Ray and CloudTrail/242_CloudWatch Agent & CloudWatch Logs Agent.txt
...
### File: outputs/AWS/aws-certified-developer-associate-DVA-C01/30_AWS Security & Encryption_ KMS, Encryption SDK, SSM Parameter Store, IAM & STS/430_CloudWatch Logs Encryption.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/04_Security/037_AWS Managed Logs.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/114_CloudWatch.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/115_CloudWatch Logs.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/11_Monitoring/118_AWS Personal Health Dashboard.txt
...
### File: outputs/AWS/aws-certified-solutions-architect-professional-SAP-C02/15_VPC/159_VPC Flow Logs.txt
