# Extraction: certified-kubernetes-administrator-with-practice-tests / 08_Storage / 191_Volume Driver Plugins in Docker
...
- Module: 08_Storage
- Lecture: 191_Volume Driver Plugins in Docker
- File: 191_Volume Driver Plugins in Docker.txt
...
Content:
There are many other volume driver plugins that allow you to create a volume on third party solutions like Azure File Storage, convoy, DigitalOcean, Block Storage Locker, Google Compute Persistent Disks, Glusterfs, NetApp X-ray Portworx, and VMware vSphere storage.
