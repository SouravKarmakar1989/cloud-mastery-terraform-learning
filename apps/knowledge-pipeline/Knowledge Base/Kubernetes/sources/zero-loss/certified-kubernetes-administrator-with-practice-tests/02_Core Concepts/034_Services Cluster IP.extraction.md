# Extraction: certified-kubernetes-administrator-with-practice-tests / 02_Core Concepts / 034_Services Cluster IP
...
- Lecture: 034_Services Cluster IP
- File: 034_Services Cluster IP.txt
- Topic: Services Cluster IP
