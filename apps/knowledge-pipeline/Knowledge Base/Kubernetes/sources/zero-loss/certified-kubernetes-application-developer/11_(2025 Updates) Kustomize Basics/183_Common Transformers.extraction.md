# Extraction: certified-kubernetes-application-developer / 11_(2025 Updates) Kustomize Basics / 183_Common Transformers
...
- Lecture: 183_Common Transformers
- File: 183_Common Transformers.txt
...
Content:
So if you want to add a specific annotation to all of your Kubernetes resources, you could just specify commonAnnotations in the Kustomization.yaml file, and then specify your desired annotation, and that's going to get added to all of your Kubernetes objects.
