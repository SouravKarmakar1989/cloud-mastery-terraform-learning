# Extraction: certified-kubernetes-application-developer / 09_Security / 166_Operator Framework
...
- Module: 09_Security
- Lecture: 166_Operator Framework
- File: 166_Operator Framework.txt
- Topic: Operator Framework
...
Content:
So Kubernetes operators do what a human operator typically will do to manage a specific application such as installing it, maintaining it, by taking backups, and restoring backups in case of disasters, fixing any issues that may come across the application, et cetera.
