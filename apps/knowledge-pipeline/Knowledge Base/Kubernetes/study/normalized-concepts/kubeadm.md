# Normalized Concept: Kubeadm

- Concept Key: kubeadm
- Matched Global Concept Blocks: 8
- Source-backed Note Entries Used: 1772
...
- Matched Global Concepts:
  ...
  - Demo - Setting Up Virtual Machines on Windows (match score: 1, notes: 217)
  - Kubernetes Setup - Kubeadm (match score: 1, notes: 21)
  - Deployment With Kubeadm - Provision VMs With Vagrant (match score: 1, notes: 53)
...
- Course/Section Perspective Coverage:
  ...
  - certified-kubernetes-administrator-with-practice-tests / 11_Install _Kubernetes the kubeadm way_: 515 note entries
  - certified-kubernetes-administrator-with-practice-tests / 17_Mock Exams: 485 note entries
  - learn-kubernetes / 11_Appendix - Setup Multi Node cluster using Kubeadm: 615 note entries
