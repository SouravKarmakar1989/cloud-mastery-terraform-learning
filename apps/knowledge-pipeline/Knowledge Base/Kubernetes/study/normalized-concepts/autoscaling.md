# Normalized Concept: Autoscaling

- Concept Key: autoscaling
- Matched Global Concept Blocks: 8
- Source-backed Note Entries Used: 1765
...
- Matched Global Concepts:
  ...
  - (2025 Updates) Introduction to Autoscaling_ (match score: 3, notes: 51)
  ...
  - API Versions (match score: 1, notes: 77)
...
- Course/Section Perspective Coverage:
  ...
  - certified-kubernetes-application-developer / 06_POD Design: 47 note entries
  - certified-kubernetes-application-developer / 09_Security: 77 note entries
