...
- outputs/aws-solutions-architect-professional/06_Storage/078_AWS DataSync - Solution Architecture.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/177_Storage Gateway Overview.txt
- outputs/aws-solutions-architect-professional/06_Storage/080_AWS Transfer Family.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/179_AWS Transfer Family.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/180_DataSync - Overview.txt
- outputs/aws-solutions-architect-professional/06_Storage/077_AWS DataSync.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/178_Storage Gateway Hands On.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/172_AWS Snow Family Overview.txt
- outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/173_AWS Snow Family Hands On.txt
...
> Source: aws-certified-cloudops-associate transcripts — 167_Storage Gateway for CloudOps.txt

### Storage Gateway — SysOps Operational Details

#### File Gateway: POSIX Compliance
- File Gateway is POSIX-compliant (Linux file system semantics).
- Object metadata — owner, permissions, timestamps — is stored in the S3 object's metadata alongside the content.
...
- Method 1 (CLI): Use the Gateway VM CLI on first start → select "0: Get Activation Key" and paste the key into the Storage Gateway Console.
...
- Gateway VM clock drift — VM must synchronize time via NTP; excessive drift from the NTP server causes activation failure.

#### Volume Gateway Cached Mode — Cache Efficiency Monitoring
- Only the most recently accessed data is stored locally on the Volume Gateway; the rest remains in S3.
- **CacheHitPercent** (CloudWatch): target HIGH (e.g., ≥80%). High value = cache serving reads efficiently, low latency. Low value = too many cache misses.
- **CachePercentUsed** (CloudWatch): watch this — if too high, cache is near capacity and may evict useful data.
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/172_AWS Snow Family Overview.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/173_AWS Snow Family Hands On.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/177_Storage Gateway Overview.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/178_Storage Gateway Hands On.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/179_AWS Transfer Family.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/16_AWS Storage Extras/180_DataSync - Overview.txt
...
### File: outputs/aws-solutions-architect-professional/06_Storage/077_AWS DataSync.txt
...
### File: outputs/aws-solutions-architect-professional/06_Storage/078_AWS DataSync - Solution Architecture.txt
...
### File: outputs/aws-solutions-architect-professional/06_Storage/080_AWS Transfer Family.txt
