...
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/100_[CCP_SAA_DVA_SOA] CloudFront Overview.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/108_CloudFront - Other.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/106_[DVA] CloudFront - Field Level Encryption.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/101_[CCP_SAA_DVA_SOA] CloudFront Hands On.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/102_[SAA_DVA_SOA] CloudFront - ALB_EC2 as an Origin.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/107_CloudFront - Origin Access Control and Origin Access Identity (OAC & OAI).txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/105_[DVA] CloudFront - Signed URL & Cookies - Hands On.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/104_[DVA] CloudFront - Signed URL & Cookies.txt
- outputs/aws-solutions-architect-professional/04_Security/032_AWS WAF - Web Application Firewall.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/115_[SAA] DDoS Attack Protection.txt
...
- Primary transcript files:
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/117_[SAA_DVA] API Gateway - Hands On.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/093_[SAA_SOA] NACL & Security Groups.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/113_WAF - Hands On.txt
- outputs/aws-solutions-architect-professional/04_Security/032_AWS WAF - Web Application Firewall.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/109_WAF - Web Application Firewall.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/094_[SAA_SOA] NACL & Security Groups - Hands On.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/120_Route 53 - DNSSEC.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/116_[SAA_DVA] API Gateway.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/101_[CCP_SAA_DVA_SOA] CloudFront Hands On.txt
- outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/105_[DVA] CloudFront - Signed URL & Cookies - Hands On.txt
- Top concept clusters from transcript metadata:
- Network Security Operational Context
...
### File: outputs/aws-solutions-architect-professional/04_Security/031_DDoS and AWS Shield.txt
...
### File: outputs/aws-solutions-architect-professional/04_Security/032_AWS WAF - Web Application Firewall.txt
...
### File: outputs/aws-solutions-architect-professional/04_Security/033_AWS Firewall Manager.txt
...
### File: outputs/aws-solutions-architect-professional/04_Security/034_Blocking an IP Address.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/100_[CCP_SAA_DVA_SOA] CloudFront Overview.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/101_[CCP_SAA_DVA_SOA] CloudFront Hands On.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/102_[SAA_DVA_SOA] CloudFront - ALB_EC2 as an Origin.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/103_[SAA_DVA_SOA] CloudFront - Geo Restriction.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/104_[DVA] CloudFront - Signed URL & Cookies.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/105_[DVA] CloudFront - Signed URL & Cookies - Hands On.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/106_[DVA] CloudFront - Field Level Encryption.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/107_CloudFront - Origin Access Control and Origin Access Identity (OAC & OAI).txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/108_CloudFront - Other.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/109_WAF - Web Application Firewall.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/110_[SAA] Shield.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/111_[SAA] AWS Firewall Manager.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/112_[SAA] WAF & Shield - Hands On.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/113_WAF - Hands On.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/115_[SAA] DDoS Attack Protection.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/119_[CCP_SOA] AWS Artifact.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/120_Route 53 - DNSSEC.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/121_[SAA_SOA] AWS Network Firewall.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/122_AWS Network Firewall - Advanced.txt
...
### File: outputs/AWS Speciality/Security/05_Domain 3 - Infrastructure Security/123_Amazon SES.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/26_AWS Security & Encryption_ KMS, SSM Parameter Store, Shield, WAF/308_Web Application Firewall (WAF).txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/26_AWS Security & Encryption_ KMS, SSM Parameter Store, Shield, WAF/309_Shield - DDoS Protection.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/26_AWS Security & Encryption_ KMS, SSM Parameter Store, Shield, WAF/310_Firewall Manager.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/26_AWS Security & Encryption_ KMS, SSM Parameter Store, Shield, WAF/311_WAF & Shield - Hands On.txt
...
### File: outputs/aws-certified-solutions-architect-associate-saa-c03/26_AWS Security & Encryption_ KMS, SSM Parameter Store, Shield, WAF/312_DDoS Protection Best Practices.txt
...
## Step 3 — Deep Expansion (Core Network Security Concepts and Services)
